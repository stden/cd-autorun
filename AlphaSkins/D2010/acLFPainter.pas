...
{$DEFINE VER645} // Disable this key for support DevEx v6.44 and older
...
//      AState: TcxButtonState);
    ...
    class procedure DrawGroupBoxContent(ACanvas: TcxCanvas; ABorderRect: TRect; ACaptionPosition: TcxGroupBoxCaptionPosition{$IFDEF VER645}; ABorders: TcxBorders = cxBordersAll{$ENDIF}); override;
...
class procedure TcxACLookAndFeelPainter.DrawGroupBoxContent(ACanvas: TcxCanvas; ABorderRect: TRect; ACaptionPosition: TcxGroupBoxCaptionPosition{$IFDEF VER645}; ABorders: TcxBorders = cxBordersAll{$ENDIF});
var
  aBord : TcxBorders;
begin
  if Skinned then begin
